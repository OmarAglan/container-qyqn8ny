...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qyqn8ny.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qyqn8ny.containers.anotherwebservice.com/
...
```
git clone git@github.com:OmarAglan/container-qyqn8ny.git
cd container-qyqn8ny
```
...
```
docker attach container-qyqn8ny
```
